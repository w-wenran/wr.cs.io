...
define([],function(){
    ...
    var header = {
        ...
        height:120,
        cols:[
            { css: "image", template:img, data:{src:"imgs/file0002.jpg", title: "陶艺DIY"} },
            { css: "image", template:img, data:{src:"imgs/file0004.jpg", title: "雕塑"} },
            { css: "image", template:img, data:{src:"imgs/file0007.jpg", title: "软陶头像"} }
        ],
        navigation:{
            type: "side",
            buttons:false,
